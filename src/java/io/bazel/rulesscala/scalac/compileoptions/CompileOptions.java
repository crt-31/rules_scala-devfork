...
public class CompileOptions {
  ...
  public final String[] scalaCompilerJars;
  ...
  public CompileOptions(String[] lines) {
    ...
    scalaCompilerJars = args.getOrEmpty("ScalaCompilerJars");;
  }
    ...
    Args(String[] lines) {
      ...
      for (int i = 1, n = lines.length; i <= n; i++) {
        if (i == n || lines[i].startsWith("--")) {
          index.put(lines[opt].substring(2), Arrays.copyOfRange(lines, opt + 1, i));
          opt = i;
        }
      }
    }
